// src/pages/TVNotFound.jsx
import React from "react";
import "../styles/TVNotFound.css"; // Make sure this matches your actual CSS path

export default function TVNotFound() {
  return (
      <div
        className="tv-notfound-container"
        style={{
          backgroundImage: "url('/public/brand.PNG')",
